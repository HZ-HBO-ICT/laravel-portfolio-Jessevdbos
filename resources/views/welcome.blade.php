...
<header class="navigationHeader">
    ...
    <nav class="navLi nav">
        <ul class="homepage">
            ...
            <li id="active"><a href="#contentSite">Home</a></li>
...
<div>
    <div class="textStyling intro">
        <!-- (id: content) gebruikt voor quick acces over de pagina -->
        <h1 id="contentSite">content website</h1>
    ...
    <div class="textStyling intro">
        <h1>De Website</h1>
        <p>Goedendag,</p>
        <p>Ik ben Jesse, de developer van deze website. Voor meer informatie over mezelf verwijs ik u naar mijn <a href="profile.html">profile page</a>.<br><br> ICT wordt steeds belangrijker in de wereld. Overheden, multinationals, kleine bedrijven,
