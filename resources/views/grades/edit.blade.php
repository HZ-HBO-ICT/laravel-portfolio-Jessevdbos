        ...
        <div>
            ...
            <form method="POST" action="{{ route('grades.show', $grade) }}">
                ...
                <div class="field">
                    ...
                    <div>
                        <input class="input" type="text" name="lowest_passing_grade" id="lowest_passing_grade"
                               required min="0" max="10" value="{{ $grade->lowest_passing_grade }}">
                    </div>
                </div>
                ...
                <div class="field">
                    ...
                    <div>
                        <input class="input" type="text" name="best_grade" id="best_grade"
                               required min="0" max="10" value="{{ $grade->best_grade }}">
                    </div>
                </div>
